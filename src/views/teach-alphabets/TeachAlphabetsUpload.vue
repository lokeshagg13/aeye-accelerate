          ...
          >
            <div>
              ...
              <div class="p-3">
                ...
                will create a game from your picture where they can
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        alt="..."
                        src="@/assets/images/rabbit-mascot-eating.png"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <i
                        >Click on the
                        <span class="text-emerald-500">green dots</span> in your
                  ...
                  >
                    <img
                      alt="..."
                      src="@/assets/images/rabbit-mascot-sitting.png"
...
export default {
  ...
  methods: {
    ...
    async handleImageFileUploadButton() {
      ...
      if (file) {
        await this.reinstantiateLearnData();
    ...
    async fetchImageLearningForDemo() {
      ...
      this.currentLearnData.imageURL = data.image_data.original_image_url;

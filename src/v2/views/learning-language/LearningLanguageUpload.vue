    ...
    >
      <div class="container mx-auto items-center justify-center flex flex-wrap">
        <div class="w-full md:w-10/12 lg:w-10/12 xl:w-10/12 px-4">
          <div
            v-if="!learnModeOn & uploadedImage"
          ...
          <div
            v-if="learnModeOn | (!learnModeOn & !uploadedImage)"
            class="pt-32 sm:pt-0"
          >
            <h2 class="mt-12 font-semibold text-4xl text-blueGray-600">
              Let's Learn Words and Alphabets with your Image
            </h2>
                ...
                <div class="flex flex-wrap">
                  ...
                  >
                    <div class="flex flex-wrap justify-between">
                      <img src="@/v2/assets/icons/upload-icon.svg" width="30" />
                      <span class="ml-3"
                        >Upload new<br />
                        image</span
                      >
                  ...
                  <img
                    v-if="!uploadedImage"
                    src="@/v2/assets/icons/hand-point-left-icon.svg"
                    width="30"
                  />
                </div>
                <button
                  ...
                  class="bg-emerald-500 text-white active:bg-emerald-600 font-bold uppercase text-base px-6 py-3 rounded shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
                  @click="handleClearFileButtonClick"
                >
                  <div class="flex flex-wrap justify-between">
                    <img src="@/v2/assets/icons/erase-icon.svg" width="30" />
                    <span class="ml-3">Clear uploaded <br />image</span>
                  </div>
                </button>
              </div>
              <div
            ...
            <div class="pt-6">
              <div class="flex flex-wrap justify-between mr-auto ml-auto">
                ...
                >
                  <div
                    v-if="!uploadedImage"
                    class="relative flex flex-col min-w-0 py-8 bg-white w-full mb-6 shadow-lg rounded-lg"
                  >
                    ...
                    >
                      <img
                        alt="..."
                        src="@/v2/assets/images/image-2.1.1.svg"
                        class="w-20 align-middle rounded-t-lg"
                      />
                    </div>
                  </div>
                  <div
                ...
                <div
                  v-if="uploadedImage & isObjectSelected"
                ...
                >
                  ...
                  <div
                    class="mt-12 min-h-20-px w-full border border-solid border-blueGray-300"
                  >
                    <h5 class="font-semibold text-xl text-blueGray-600">
                ...
                <div
                  v-if="!uploadedImage | (uploadedImage & !isObjectSelected)"
                  class="w-full md:w-4/12 px-4 pt-12"
                >
                  <div
                    class="w-full border border-solid border-blueGray-300"
                  >
                    <h5
                      v-if="!uploadedImage"
                      class="font-semibold text-xl text-blueGray-600"
                    >
                      <i
                        >How can <b>Artificial Intelligence (AI)</b><br />
                        help you learn English? Upload an<br />
                        image of your choice, and see the<br />
                        magic unfold.</i
                      >
                    </h5>
                    <h5
...
export default {
  ...
  methods: {
    ...
    async handleImageFileUpload(event) {
      ...
      if (file) {
        await this.fetchImageLearningData(file);
      }
    },

    async fetchImageLearningData(file) {
      try {
        ...
        const response = await fetch(
          "https://07bf-20-5-25-56.ngrok-free.app/api/create-image-learning",
          {
            method: "POST",
            headers: {
        ...
        if (
          ...
          throw new Error(
            "Error fetching objects data for the image from the database"
          );
        }
        this.currentLearnData.imageURL = URL.createObjectURL(file);
        this.currentLearnData.markedImageData = `data:image/jpeg;base64, ${data.image_encoded}`;
    ...
    async handleImageClick(event) {
      if (!this.learnModeOn || !this.uploadedImage) {
        return;
      }

        ...
        <div class="w-full md:w-10/12 lg:w-10/12 xl:w-10/12 px-4">
          ...
          >
            <h2 class="mt-12 font-semibold text-4xl text-blueGray-600">
              Let's Test English with Your Image!
            </h2>
            ...
            <div class="pt-6">
              <div class="flex flex-wrap justify-between mr-auto ml-auto">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        alt="..."
                        src="@/v2/assets/images/image-3.2.1.jpeg"
                ...
                <div v-if="uploadedImage" class="w-full md:w-4/12 px-4 pt-12">
                  <div
                ...
                <div v-if="!uploadedImage" class="w-full md:w-4/12 px-4 pt-12">
                  ...
                  >
                    <h5 class="font-semibold text-xl text-blueGray-600">
                      <i
                        >To create your new English test,<br />
                        just upload any image of your<br />
                        choice. The <b>Artificial Intelligence</b><br />
  ...
  methods: {
    getHtmlForResponseText(type, incorrectName) {
      switch (type) {
        ...
        case "last":
          return `<b><span class="text-3xl">Well Done! Let's<br><span class="text-emerald-500"><i>upload a new image</i></span><br>for another test.</span></b>`;
        default:
    ...
    async fetchImageTestingData(file) {
      try {
        ...
        const response = await fetch(
          `https://c330-20-191-199-83.ngrok-free.app/api/create-image-testing`,
          {
            method: "POST",
            headers: {
        ...
        if (
          ...
          throw new Error(
            "Error creating and fetching Test for the Image from the database"
          );
        }
